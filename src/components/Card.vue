<template>
    <section id='cardType' :class='element'>
        <h2>{{ title }}</h2>
        <p>
...
<script>
import cardImage1 from '@/assets/img/card_bg01.jpg';
import cardImage2 from '@/assets/img/card_bg02.jpg';
import cardImage3 from '@/assets/img/card_bg03.jpg';
